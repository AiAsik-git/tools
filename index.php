...
<head>
    ...
    <title>iLoveTools - Your Ultimate Online Tools Collection</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="row mb-4">
            <div class="col-12">
                ...
                <div class="d-flex flex-wrap justify-content-center gap-2">
                    ...
                    <button class="btn btn-outline-primary category-btn" data-category="pdf">PDF Tools</button>
                    ...
                    <!-- <button class="btn btn-outline-primary category-btn" data-category="converter">Unit Converters</button> -->
