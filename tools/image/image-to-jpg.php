...
<head>
    ...
    <title>Image to JPG Converter - iLoveTools</title>
    <!-- Bootstrap CSS -->
...
<body>
            ...
            <div class="col-md-8 mx-auto">
                <div class="tool-container">
                    <h2 class="text-center mb-4">
                        <i class="fas fa-image me-2"></i>Image to JPG Converter asik 
                    </h2>
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <h5 class="card-title">JPG Quality Settings</h5>
                            <div class="mb-3">
                            ...
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="checkbox" id="removeTransparency" checked>
                                <label class="form-check-label" for="removeTransparency">
                                    Remove Transparency (Replace with white background)
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <p><strong>JPG Size:</strong> <span id="jpgSize">-</span></p>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const removeTransparency = document.getElementById('removeTransparency');
            const originalFormat = document.getElementById('originalFormat');
            const originalSize = document.getElementById('originalSize');
            const jpgSize = document.getElementById('jpgSize');
            ...
            convertBtn.addEventListener('click', function() {
                if (currentFile) {
                    ...
                    img.onload = function() {
                        ...
                        // If removing transparency, fill with white background
                        ...
                        jpgSize.textContent = formatFileSize(jpgBlob.size);
                    };
