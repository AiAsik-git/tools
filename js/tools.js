const toolsData = {
    ...
    pdf: [
        ...
        },
        {
            ...
            link: 'tools/pdf/pdf-merger.html'
        },
        {
            id: 'pdf-splitter',
            title: 'PDF Splitter',
            description: 'Extract pages from a PDF file into a new document',
            icon: 'fa-cut',
            link: 'tools/pdf/pdf-splitter.html'
        },
        {
            id: 'pdf-protect',
            title: 'PDF Protect',
            description: 'Secure your PDF with password and permissions',
            icon: 'fa-lock',
            link: 'tools/pdf/pdf-protect.html'
        },
        {
            id: 'excel-to-pdf',
            title: 'Excel to PDF',
        ...
        },
        {
            id: 'pdf-to-excel',
            title: 'PDF to Excel',
            description: 'Extract tables from PDF documents and convert to Excel',
            icon: 'fa-file-excel',
        ...
        },
        {
            id: 'html-to-pdf',
            title: 'HTML to PDF',
            description: 'Convert web pages to PDF documents with customizable options',
            icon: 'fa-file-pdf',
